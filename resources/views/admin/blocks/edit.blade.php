<x-app-layout-admin>
    <div class="card">
        <div class="card-header"><h3>Edit Block</h3></div>
        ...
        <form method="POST" action="{{ route('blocks.update', $block) }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="sub_division_id" class="form-control" required>
                        ...
                        @foreach($subDivisions as $id => $name)
                            <option value="{{ $id }}" {{ $block->sub_division_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name', $block->name) }}" class="form-control" required>
